        ...
        Comm: {
            ...
            genCommExport(isPrint = false) {
                ...
                palletsToExport.forEach(palletNum => {
                    let pLog = [];
                    if (isSeparate) {
                        pLog = [...State.commLog].filter(r => r.pallet === palletNum);
                        if (pLog.length === 0) return;
                    } else {
                        pLog = [...State.commLog];
                    }
                    ...
                    // Fixed TSV extraction to prevent Spreadsheet Formula Evaluation errors
                    ...
                    // Decoupled Print formatting from Clipboard formatting to prevent paste truncation
