    ...
    const App = {
        ...
        Rapid: {
            ...
            exportLog(isPrint) {
                ...
                const th = CONFIG.exportTheme; // Shorthand for styling variables
                let plainText = "Batch\tPet Name\tFamily Name\tClinic\tKeepsakes\tInitials\n";

                let tableHtml = `<div><h3 style="font-family:-apple-system,sans-serif;">Communal Check-In Log</h3><table cellspacing="0" border="0" cellpadding="0" style="border-collapse:collapse;border:${th.borderThick};font-family:${th.fontFamily};font-size:${th.bodyFontSize};width:100%;"><tr style="height:${th.rowHeightHeader};background-color:${th.bgHeader};"><td style="border:${th.borderThick};padding:${th.logPadding};text-align:center;width:8%;"><b>Batch</b></td><td style="border:${th.borderThick};padding:${th.logPadding};width:24%;"><b>Pet Name</b></td><td style="border:${th.borderThick};padding:${th.logPadding};width:24%;"><b>Family Name</b></td><td style="border:${th.borderThick};padding:${th.logPadding};width:24%;"><b>Clinic</b></td><td style="border:${th.borderThick};padding:${th.logPadding};text-align:center;width:12%;"><b>Keepsakes</b></td><td style="border:${th.borderThick};padding:${th.logPadding};text-align:center;width:8%;"><b>Initials</b></td></tr>`;
                ...
                for (let i = 0; i < logLen; i++) {
                    ...
                    let bg = (i % 2 === 0) ? `background-color:${th.bgEven};` : `background-color:${th.bgOdd};`;
                    let bBtm = (i === logLen - 1) ? th.borderThick : th.borderThin;

                    tableHtml += `<tr style="height:${th.rowHeightBody}; ${bg}"><td style="padding:${th.logPadding}; border-left:${th.borderThick}; border-right:${th.borderThin}; border-top:${th.borderThin}; border-bottom:${bBtm}; text-align:center;"><b>${rB}</b></td><td style="padding:${th.logPadding}; border-left:${th.borderThin}; border-right:${th.borderThin}; border-top:${th.borderThin}; border-bottom:${bBtm};">${rP}</td><td style="padding:${th.logPadding}; border-left:${th.borderThin}; border-right:${th.borderThin}; border-top:${th.borderThin}; border-bottom:${bBtm};">${rF}</td><td style="padding:${th.logPadding}; border-left:${th.borderThin}; border-right:${th.borderThin}; border-top:${th.borderThin}; border-bottom:${bBtm};">${rC}</td><td style="padding:${th.logPadding}; border-left:${th.borderThin}; border-right:${th.borderThin}; border-top:${th.borderThin}; border-bottom:${bBtm}; text-align:center;"><b>${rK}</b></td><td style="padding:${th.logPadding}; border-left:${th.borderThin}; border-right:${th.borderThick}; border-top:${th.borderThin}; border-bottom:${bBtm}; text-align:center;">${rI}</td></tr>`;
                }
                tableHtml += `</table></div>`;
                ...
                if (isPrint) {
                    let tableRows = ''; State.rapidLog.forEach((row, index) => { let printBgStyle = (index % 2 === 0) ? `background-color:${th.bgEven};` : `background-color:${th.bgOdd};`; tableRows += `<tr style="${printBgStyle}"><td style="text-align:center;">${row.batch}</td><td>${row.pet}</td><td>${row.family}</td><td>${row.clinic}</td><td style="text-align:center; font-size:11px; font-weight:bold;">${row.keepsakes}</td><td style="text-align:center;">${row.initials}</td></tr>`; });
        ...
        Comm: {
            ...
            genCommExport(isPrint = false) {
                const st = this.getCommStats();
                const th = CONFIG.exportTheme; // Shorthand for styling variables
                let sumHtml = '', tsv = "SUMMARY\nPallet #\tStart Time\tStart Temp\tSmall\tMedium\tLarge\tTotal Count\tCombined Weight\n";

                const hHtml = `<tr style="height:${th.rowHeightHeader};"><td width="75" style="width:56.15pt;background-color:${th.bgHeader};padding:${th.summaryPadding};border-left:${th.borderThick};border-top:${th.borderThick};border-right:${th.borderThick};border-bottom:${th.borderThick};"><p style="text-align:center;margin:0;"><span style="font-family:${th.fontFamily};font-size:${th.headerFontSize};color:#000000;"><b>Pallet #</b></span></p></td><td width="80" style="width:60.25pt;background-color:${th.bgHeader};padding:${th.summaryPadding};border-left:${th.borderThick};border-top:${th.borderThick};border-right:${th.borderThin};border-bottom:${th.borderThick};"><p style="text-align:center;margin:0;"><span style="font-family:${th.fontFamily};font-size:${th.headerFontSize};color:#000000;"><b>Start Time</b></span></p></td><td width="80" style="width:60.25pt;background-color:${th.bgHeader};padding:${th.summaryPadding};border-left:${th.borderThin};border-top:${th.borderThick};border-right:${th.borderThick};border-bottom:${th.borderThick};"><p style="text-align:center;margin:0;"><span style="font-family:${th.fontFamily};font-size:${th.headerFontSize};color:#000000;"><b>Start Temp</b></span></p></td><td width="97" style="width:72.7pt;background-color:${th.bgHeader};padding:${th.summaryPadding};border-left:${th.borderThick};border-top:${th.borderThick};border-right:${th.borderThin};border-bottom:${th.borderThick};"><p style="text-align:center;margin:0;"><span style="font-family:${th.fontFamily};font-size:${th.headerFontSize};color:#000000;"><b>Small</b></span></p></td><td width="97" style="width:72.7pt;background-color:${th.bgHeader};padding:${th.summaryPadding};border-left:${th.borderThin};border-top:${th.borderThick};border-right:${th.borderThin};border-bottom:${th.borderThick};"><p style="text-align:center;margin:0;"><span style="font-family:${th.fontFamily};font-size:${th.headerFontSize};color:#000000;"><b>Medium</b></span></p></td><td width="97" style="width:72.7pt;background-color:${th.bgHeader};padding:${th.summaryPadding};border-left:${th.borderThin};border-top:${th.borderThick};border-right:${th.borderThick};border-bottom:${th.borderThick};"><p style="text-align:center;margin:0;"><span style="font-family:${th.fontFamily};font-size:${th.headerFontSize};color:#000000;"><b>Large</b></span></p></td><td width="97" style="width:72.7pt;background-color:${th.bgHeader};padding:${th.summaryPadding};border-left:${th.borderThick};border-top:${th.borderThick};border-right:${th.borderThick};border-bottom:${th.borderThick};"><p style="text-align:center;margin:0;"><span style="font-family:${th.fontFamily};font-size:${th.headerFontSize};color:#000000;"><b>Total</b></span></p></td><td width="97" style="width:72.7pt;background-color:${th.bgHeader};padding:${th.summaryPadding};border-left:${th.borderThick};border-top:${th.borderThick};border-right:${th.borderThick};border-bottom:${th.borderThick};"><p style="text-align:center;margin:0;"><span style="font-family:${th.fontFamily};font-size:${th.headerFontSize};color:#000000;"><b>Combined Weight</b></span></p></td></tr>`;

                const buildRow = (lbl, S, M, L, T, W, bg, isL) => {
                    let bb = isL ? th.borderThick : th.borderThin;
                    return `<tr style="height:${th.rowHeightBody};"><td style="width:56.15pt;background-color:${bg};padding:${th.summaryPadding};border-left:${th.borderThick};border-top:${th.borderThin};border-right:${th.borderThick};border-bottom:${bb};"><p style="text-align:center;margin:0;"><span style="font-family:${th.fontFamily};font-size:${th.bodyFontSize};color:#000;"><b>${lbl}</b></span></p></td><td style="width:60.25pt;background-color:${bg};padding:${th.summaryPadding};border-left:${th.borderThick};border-top:${th.borderThin};border-right:${th.borderThin};border-bottom:${bb};"></td><td style="width:60.25pt;background-color:${bg};padding:${th.summaryPadding};border-left:${th.borderThin};border-top:${th.borderThin};border-right:${th.borderThick};border-bottom:${bb};"></td><td style="width:72.7pt;background-color:${bg};padding:${th.summaryPadding};border-left:${th.borderThick};border-top:${th.borderThin};border-right:${th.borderThin};border-bottom:${bb};"><p style="text-align:center;margin:0;"><span style="font-family:${th.fontFamily};font-size:${th.bodyFontSize};color:#000;">${S}</span></p></td><td style="width:72.7pt;background-color:${bg};padding:${th.summaryPadding};border-left:${th.borderThin};border-top:${th.borderThin};border-right:${th.borderThin};border-bottom:${bb};"><p style="text-align:center;margin:0;"><span style="font-family:${th.fontFamily};font-size:${th.bodyFontSize};color:#000;">${M}</span></p></td><td style="width:72.7pt;background-color:${bg};padding:${th.summaryPadding};border-left:${th.borderThin};border-top:${th.borderThin};border-right:${th.borderThick};border-bottom:${bb};"><p style="text-align:center;margin:0;"><span style="font-family:${th.fontFamily};font-size:${th.bodyFontSize};color:#000;">${L}</span></p></td><td style="width:72.7pt;background-color:${bg};padding:${th.summaryPadding};border-left:${th.borderThick};border-top:${th.borderThin};border-right:${th.borderThick};border-bottom:${bb};"><p style="text-align:center;margin:0;"><span style="font-family:${th.fontFamily};font-size:${th.bodyFontSize};color:#000;"><b>${T}</b></span></p></td><td style="width:72.7pt;background-color:${bg};padding:${th.summaryPadding};border-left:${th.borderThick};border-top:${th.borderThin};border-right:${th.borderThick};border-bottom:${bb};"><p style="text-align:center;margin:0;"><span style="font-family:${th.fontFamily};font-size:${th.bodyFontSize};color:#000;"><b>${W}</b></span></p></td></tr>`;
                };

                const isSeparate = State.settings.commExportFormat === 'separate';
                let logHtml = ''; let tsvLog = "\nLOG\n"; const pCount = State.settings.commPalletCount || 2;
                let palletsToExport = isSeparate ? Array.from({length: pCount}, (_, i) => i + 1) : [0];
                let isFirstTable = true;

                if (State.settings.commSummaryFormat === 'split') {
                    for(let i=1; i<=pCount; i++) {
                        tsv += `Pallet ${i}\t\t\t${st[`p${i}`].s}\t${st[`p${i}`].m}\t${st[`p${i}`].l}\t${st[`p${i}`].t}\t${st[`p${i}`].w}\n`;
                        sumHtml += buildRow(`${i}`, st[`p${i}`].s, st[`p${i}`].m, st[`p${i}`].l, st[`p${i}`].t, st[`p${i}`].w, (i%2!==0?th.bgEven:th.bgOdd), false);
                    }
                    if (pCount > 1) {
                        sumHtml += buildRow('All', st.c.s, st.c.m, st.c.l, st.c.t, st.c.w, (pCount%2!==0?th.bgOdd:th.bgEven), true);
                        tsv += `All\t\t\t${st.c.s}\t${st.c.m}\t${st.c.l}\t${st.c.t}\t${st.c.w}\n`;
                    } else { sumHtml = sumHtml.replace(`border-bottom:${th.borderThin}`, `border-bottom:${th.borderThick}`); }
                } else {
                    let combinedLabel = Array.from({length: pCount}, (_, i) => i + 1).join(pCount>2?', ':' & ').replace(/, ([^,]*)$/, ' & $1');
                    if (pCount === 1) combinedLabel = "1";
                    tsv += `${combinedLabel}\t\t\t${st.c.s}\t${st.c.m}\t${st.c.l}\t${st.c.t}\t${st.c.w}\n`;
                    sumHtml += buildRow(combinedLabel, st.c.s, st.c.m, st.c.l, st.c.t, st.c.w, th.bgEven, true);
                }
                ...
                palletsToExport.forEach(palletNum => {
                    let pLog = [];
                    if (isSeparate) { pLog = [...State.commLog].filter(r => r.pallet === palletNum); if (pLog.length === 0) return; }
                    else { pLog = [...State.commLog]; }
                    ...
                    pLog.forEach((rowObj, index) => {
                        ...
                        let bg = (index%2===0) ? `background-color:${th.bgEven};` : `background-color:${th.bgOdd};`;
                        ...
                        let bBtm = (index === pLog.length - 1) ? th.borderThick : th.borderThin;

                        tableHtml += `<tr style="height:${th.rowHeightBody}; ${bg}"><td style="padding:${th.logPadding}; border-left:${th.borderThick}; border-right:${th.borderThin}; border-top:${th.borderThin}; border-bottom:${bBtm}; text-align:center;"><b>${rB}</b></td><td style="padding:${th.logPadding}; border-left:${th.borderThin}; border-right:${th.borderThin}; border-top:${th.borderThin}; border-bottom:${bBtm}; text-align:center;">${rW}</td><td style="padding:${th.logPadding}; border-left:${th.borderThin}; border-right:${th.borderThin}; border-top:${th.borderThin}; border-bottom:${bBtm};">${rP}</td><td style="padding:${th.logPadding}; border-left:${th.borderThin}; border-right:${th.borderThin}; border-top:${th.borderThin}; border-bottom:${bBtm};">${rF}</td><td style="padding:${th.logPadding}; border-left:${th.borderThin}; border-right:${th.borderThin}; border-top:${th.borderThin}; border-bottom:${bBtm};">${rC}</td><td style="padding:${th.logPadding}; border-left:${th.borderThin}; border-right:${th.borderThin}; border-top:${th.borderThin}; border-bottom:${bBtm}; text-align:center;"><b>${rK}</b></td><td style="padding:${th.logPadding}; border-left:${th.borderThin}; border-right:${th.borderThick}; border-top:${th.borderThin}; border-bottom:${bBtm}; text-align:center;">${rI}</td></tr>`;
                    });
                    tableHtml += `</table></div>`; logHtml += tableHtml;
                });

                let wordHtml = `<html xmlns:o="urn:schemas-microsoft-com:office:office" xmlns:w="urn:schemas-microsoft-com:office:word" xmlns="http://www.w3.org/TR/REC-html40"><head><meta charset="utf-8"></head><body><h3 style="font-family:-apple-system,sans-serif;">Communal Totals</h3><table cellspacing="0" border="0" cellpadding="0" style="margin-left:0pt;border-collapse:collapse;border:${th.borderThick};margin-bottom:20pt;width:100%;">${hHtml}${sumHtml}</table>${logHtml}</body></html>`;
            ...
            exportLog(isPrint) {
                ...
                const ex = this.genCommExport(isPrint);
                if (isPrint) {
